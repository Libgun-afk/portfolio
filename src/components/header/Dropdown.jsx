...
export const Dropdown = () => {
  return (
    <div className="flex-col-reverse px-4 py-16 items-center  justify-between md:flex-row flex  md:py-4 md:px-8 gap-12 bg-black text-white">
      <div className="flex gap-12 flex-col md:w-[768px] ">
